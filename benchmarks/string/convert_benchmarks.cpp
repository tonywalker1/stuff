...
TEST_CASE("convert strings to integers", "[string_benchmarks]")
{
    ...
    BENCHMARK("lexical_cast") { return boost::lexical_cast<long>(str); };

    BENCHMARK("stol") { return std::stol(str); };
...
TEST_CASE("convert strings to doubles", "[string_benchmarks]")
{
    ...
    BENCHMARK("lexical_cast") { return boost::lexical_cast<double>(str); };

    BENCHMARK("stod") { return std::stod(str); };
